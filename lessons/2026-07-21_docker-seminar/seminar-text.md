...
- [PART 0｜Dockerの基礎](#part-0dockerの基礎)
  - [1｜Dockerとは？](#1dockerとは)
  - [2｜コンテナとは？](#2コンテナとは)
  - [3｜Dockerイメージとは？](#3dockerイメージとは)
  - [4｜Docker Composeとは？](#4docker-composeとは)
  - [5｜WordPress制作では、どんなときにDockerを使う？](#5wordpress制作ではどんなときにdockerを使う)
  - [6｜Localとの違い](#6localとの違い)
  - [7｜Dockerを使うメリット](#7dockerを使うメリット)
  - [8｜Dockerを使うデメリット](#8dockerを使うデメリット)
  - [9｜Dockerを使えば本番公開もできる？](#9dockerを使えば本番公開もできる)
  - [10｜今回作る環境](#10今回作る環境)
  - [11｜この教材で理解すること](#11この教材で理解すること)
  - [12｜最初に覚えておきたい言葉](#12最初に覚えておきたい言葉)
  - [13｜完成後の状態](#13完成後の状態)
- [事前準備](#事前準備)
  - [STEP 1｜Docker Desktopをインストールする](#step-1docker-desktopをインストールする)
  - [STEP 2｜Dockerが動いているか確認する](#step-2dockerが動いているか確認する)
- [PART 1｜WordPress全体をローカルに置く](#part-1wordpress全体をローカルに置く)
  - [STEP 3｜作業フォルダを作る](#step-3作業フォルダを作る)
  - [STEP 4｜compose.yamlを作る](#step-4composeyamlを作る)
  - [compose.yamlの意味を確認する](#composeyamlの意味を確認する)
  - [WordPressを起動する](#wordpressを起動する)
  - [STEP 5｜構成を確認する](#step-5構成を確認する)
  - [STEP 6｜設定ファイルを検証する](#step-6設定ファイルを検証する)
  - [STEP 7｜コンテナを起動する](#step-7コンテナを起動する)
  - [STEP 8｜動作状態を確認する](#step-8動作状態を確認する)
  - [STEP 9｜WordPressを開く](#step-9wordpressを開く)
  - [STEP 10｜WordPressをセットアップする](#step-10wordpressをセットアップする)
  - [STEP 11｜ローカルのファイルを確認する](#step-11ローカルのファイルを確認する)
  - [簡単なテーマを作ってみる](#簡単なテーマを作ってみる)
  - [STEP 12｜テーマフォルダを作る](#step-12テーマフォルダを作る)
  - [STEP 13｜style.cssを作る](#step-13stylecssを作る)
  - [STEP 14｜functions.phpを作る](#step-14functionsphpを作る)
  - [STEP 15｜index.phpを作る](#step-15indexphpを作る)
  - [STEP 16｜テーマを有効化する](#step-16テーマを有効化する)
  - [停止と再開](#停止と再開)
  - [STEP 17｜停止する](#step-17停止する)
  - [STEP 18｜再度起動する](#step-18再度起動する)
  - [データを完全に初期化する場合](#データを完全に初期化する場合)
- [PART 2｜テーマだけをローカルに置く](#part-2テーマだけをローカルに置く)
  - [この環境の考え方](#この環境の考え方)
  - [STEP 19｜2つ目の作業フォルダを作る](#step-192つ目の作業フォルダを作る)
  - [STEP 20｜フォルダ構成を作る](#step-20フォルダ構成を作る)
  - [STEP 21｜テーマファイルを作る](#step-21テーマファイルを作る)
  - [STEP 22｜2つ目のcompose.yamlを作る](#step-222つ目のcomposeyamlを作る)
  - [2つのマウントを理解する](#2つのマウントを理解する)
  - [2つ目の環境を起動する](#2つ目の環境を起動する)
  - [STEP 23｜設定を確認する](#step-23設定を確認する)
  - [STEP 24｜ブラウザで開く](#step-24ブラウザで開く)
  - [STEP 25｜WordPressをセットアップする](#step-25wordpressをセットアップする)
  - [STEP 26｜テーマを有効化する](#step-26テーマを有効化する)
  - [STEP 27｜PHPを編集する](#step-27phpを編集する)
  - [2つの方式の違い](#2つの方式の違い)
  - [どちらを使うか](#どちらを使うか)
  - [よく使うコマンド](#よく使うコマンド)
  - [最初に試す順番](#最初に試す順番)
- [PART 3｜チーム開発でGitHubと組み合わせる](#part-3チーム開発でgithubと組み合わせる)
  - [全体像](#全体像)
  - [GitHubで共有するもの](#githubで共有するもの)
  - [GitHubで共有しないもの](#githubで共有しないもの)
  - [各メンバーの初回セットアップ](#各メンバーの初回セットアップ)
  - [普段の開発フロー](#普段の開発フロー)
  - [Bさんはどうやって変更を受け取る？](#bさんはどうやって変更を受け取る)
  - [データベースはどう共有するの？](#データベースはどう共有するの)
  - [おすすめの役割分担](#おすすめの役割分担)
  - [Docker設定を変更した場合](#docker設定を変更した場合)
  - [各自でポートを変えたい場合](#各自でポートを変えたい場合)
  - [現実的なリポジトリ構成](#現実的なリポジトリ構成)
  - [何をGitHubで管理するか](#何をgithubで管理するか)
  - [まずはこの運用から始める](#まずはこの運用から始める)
